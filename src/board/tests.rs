...
fn test_make_null_move() {
    ...
    let expected_board =
        Board::new_from_fen("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 1 2");
    assert_eq!(
        null_board.game_state.curr_zobrist_key,
        expected_board.game_state.curr_zobrist_key
    );
